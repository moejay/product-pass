...
export function shouldUseRemoteCodex(provider: "openai-compatible" | "codex-subscription", connected: boolean, connectionsSkipped = false): boolean { return !connectionsSkipped && provider === "codex-subscription" && connected; }
